...
**Current version:** `1.2.1-rc.2` · iOS 16+
...
```swift
dependencies: [
    .package(url: "https://github.com/piplcom/device-intelligence-sdk-ios-dist.git", from: "1.2.1-rc.2")
]
```
...
```ruby
pod 'PiplDeviceIntelligence', :podspec => 'https://raw.githubusercontent.com/piplcom/device-intelligence-sdk-ios-dist/1.2.1-rc.2/PiplDeviceIntelligence.podspec'
```
