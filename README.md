...
```swift
dependencies: [
    .package(url: "https://github.com/piplcom/device-intelligence-sdk-ios-dist.git", from: "1.2.0")
]
```
...
```ruby
pod 'PiplDeviceIntelligence', :podspec => 'https://raw.githubusercontent.com/piplcom/device-intelligence-sdk-ios-dist/1.2.0/PiplDeviceIntelligence.podspec'
```
